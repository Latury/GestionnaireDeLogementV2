...
namespace GestionnaireDeLogement.Utilitaires
{
    ...
    public static class Couleurs
    {
        ...
        // ═══════════════════════════════════════════════════════════════════════════════════
        //  COULEURS D'ALERTE (ORANGE/JAUNE)
        // ═══════════════════════════════════════════════════════════════════════════════════
        //  Utilisé dans :
        ...
        /// <para> EauVue : En-tête (  + titre), graphique, boutons</para>
        ...
        /// <para> ElectriciteVue : En-tête (icone  + titre), graphique, boutons</para>
        ...
        /// <para> ChauffageVue : En-tête (icone  + titre), badge "Gaz"</para>
        ...
        /// <para> FacturesVue : En-tête (icone  + titre)</para>
        ...
        /// <para> AchatsVue : En-tête (icone  + titre), boutons</para>
        ...
        // ═══════════════════════════════════════════════════════════════════════════════════
        //  COULEURS DE TEXTE - UTILISÉES DANS TOUTES LES PAGES
        // ═══════════════════════════════════════════════════════════════════════════════════
