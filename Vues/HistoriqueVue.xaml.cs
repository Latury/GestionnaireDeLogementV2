...
namespace GestionnaireDeLogement.Vues
{
    ...
    public partial class HistoriqueVue : Page
    {
        ...
        /// <summary>
        /// 🗑️ Supprime une seule ligne d'historique
        /// </summary>
        ...
        /// <summary>
        /// 🗑️ Supprime toutes les entrées de la catégorie sélectionnée
        /// </summary>
        private void BtnSupprimerCategorie_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "⚠️ Veuillez d'abord sélectionner une catégorie spécifique (pas 'Tout').",
                    "Sélection requise",
                    MessageBoxButton.OK,
